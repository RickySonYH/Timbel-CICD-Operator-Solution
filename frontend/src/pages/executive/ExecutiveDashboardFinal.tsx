// [advice from AI] 경영진 통합 대시보드 - PO 대시보드 기반 + 전사 제어 기능
...
// [advice from AI] 상태 코드를 한글로 변환하는 함수
...
const ExecutiveDashboardFinal: React.FC = () => {
                        ...
                        <TableBody>
                          {qcProgressData.map((qcRequest) => (
                            <TableRow key={qcRequest.id} hover>
                              ...
                              <TableCell>
                                  <Chip
                            label={getStatusLabel(qcRequest.request_status)}
                                  size="small"
                                  color={
          ...
          {selectedProject && (
            <Box sx={{ pt: 1 }}>
              ...
              <Typography variant="h6" gutterBottom>
                ...
                <Typography variant="body2" sx={{ mb: 1 }}>
                  <strong>프로젝트 상태:</strong> {getStatusLabel(selectedProject.project_status)}
              </Typography>
                <Typography variant="body2">
                  ...
                  <Paper variant="outlined" sx={{ p: 2 }}>
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={6}>
                        ...
                        <Chip 
                          label={getStatusLabel(selectedQcRequest.request_status)}
                          size="small"
                          color={
                ...
                {selectedQcRequest.approval_status && (
                  <Grid item xs={12}>
                    ...
                    <Paper variant="outlined" sx={{ p: 2 }}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                        <Chip 
                          label={getStatusLabel(selectedQcRequest.approval_status)}
                        ...
                        <TableBody>
                          {pePerformanceData.pe_performance.map((pe: any) => (
                            <TableRow key={pe.pe_id} hover>
                              ...
                              <TableCell align="center">
                                <Typography variant="body2">
                                  {pe.avg_development_hours ? `${(parseFloat(pe.avg_development_hours.toString()) || 0).toFixed(1)}시간` : 'N/A'}
                                </Typography>
                              </TableCell>
                              <TableCell align="center">
                                <Typography 
                        ...
                        <TableBody>
                          {workloadDistributionData.workload_analysis.map((pe: any) => (
                            <TableRow key={pe.pe_id} hover>
                              ...
                              <TableCell align="center">
                                <Typography variant="body2">
                                  {pe.total_estimated_hours ? `${(parseFloat(pe.total_estimated_hours.toString()) || 0).toFixed(1)}시간` : 'N/A'}
                                </Typography>
                              </TableCell>
                              <TableCell align="center">
                                <Typography variant="body2">
...
export default ExecutiveDashboardFinal;